const projectapi = [
  {
    id: 1,
    name: "Fine-tuned Falcon-7B chat model for text generation",
    description:
      "This is a fine-tuned  Falcon-7B language model using the LoRA technique and the OpenAssistant Guanaco dataset. The resulting model, Falcon-7b-chat-new-finetune, is optimized for conversational AI tasks and available on Hugging Face for easy integration into your projects. The notebook utilizes techniques like 4-bit quantization.",
    link: "https://huggingface.co/chaitanya42/Falcon-7b-chat-new-finetune",
    // date: "January 2024",
  },
  {
    id: 2,
  ...
  {
    id: 4,
    name: "GrapeGauge: Wine Quality Predictive Model with MLflow",
    description:
      "Developed a machine learning pipeline using MLflow to predict wine quality, achieving 90% accuracy and significantly enhancing quality assessment procedures. The project uses MLflow which is used for experiment tracking.",
    link: "https://github.com/chaitanya-24/Wine-Quality-Prediction-with-MLflow",
    // date: "November 2023",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    link: "https://github.com/chaitanya-24/Movie-Recommender-System",
    // date: "January 2024",
  },
